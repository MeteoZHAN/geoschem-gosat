...
% 提取各站点一天多个值提取为一天一个值
[ae_station] = unique_stations(ae1); % 获取站点某日柱浓度数据
[br_station] = unique_stations(br1); % 获取站点某日柱浓度数据
[db_station] = unique_stations(db1);
[iz_station] = unique_stations(iz1);
[Lamont_station] = unique_stations(Lamont1);
[tk_station] = unique_stations(tk1);
[wg_station] = unique_stations(wg1);
