...
% 提取各站点一天多个值提取为一天一个值
[ae_station] = unique_stations(ae4); % 获取站点某日柱浓度数据
[br_station] = unique_stations(br4); % 获取站点某日柱浓度数据
[db_station] = unique_stations(db4);
[iz_station] = unique_stations(iz4);
[Lamont_station] = unique_stations(Lamont4);
[tk_station] = unique_stations(tk4);
[wg_station] = unique_stations(wg4);
