...
% 提取各站点一天多个值提取为一天一个值
%  [ae_station] = unique_stations(ae5); % 获取站点某日柱浓度数据,该站5月无数据
[br_station] = unique_stations(br5); % 获取站点某日柱浓度数据
[db_station] = unique_stations(db5);
[iz_station] = unique_stations(iz5);
[Lamont_station] = unique_stations(Lamont5);
[tk_station] = unique_stations(tk5);
[wg_station] = unique_stations(wg5);
