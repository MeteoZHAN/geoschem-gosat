...
% 提取各站点一天多个值提取为一天一个值
[ae_station] = unique_stations(ae6); % 获取站点某日柱浓度数据
[br_station] = unique_stations(br6); % 获取站点某日柱浓度数据
[db_station] = unique_stations(db6);
[iz_station] = unique_stations(iz6);
[Lamont_station] = unique_stations(Lamont6);
[tk_station] = unique_stations(tk6);
[wg_station] = unique_stations(wg6);
